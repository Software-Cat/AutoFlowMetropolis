...
namespace WebSocketTraffic
{
    ...
    {
        public CinemachineVirtualCamera freeFlyVirtualCam;
        ...
        private void Start()
        {
            ...
            freeFlyVirtualCam.enabled = false;
        }
        ...
        private Vector3 HandleKeyInput()
        {
            ...
            //key input detection
            if (Input.GetKey(Forwards)) acceleration.z += 1;

            if (Input.GetKey(Backwards)) acceleration.z -= 1;

            if (Input.GetKey(Left)) acceleration.x -= 1;

            if (Input.GetKey(Right)) acceleration.x += 1;

            if (Input.GetKey(Up)) acceleration.y += 1;

            if (Input.GetKey(Down)) acceleration.y -= 1;
